...
public class Board {
  ...
  public Board() {
    ...
    this.addSquare(new CommunityChest("Community Chest",2));
    ...
    this.addSquare(new Chance("Chance",7));
    ...
    this.addSquare(new CommunityChest("Community Chest",17));
    ...
    this.addSquare(new Chance("Chance",22));
    ...
    this.addSquare(new CommunityChest("Community Chest",33));
    ...
    this.addSquare(new Chance("Chance",36));
